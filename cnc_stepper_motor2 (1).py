#!/usr/bin/env python3
"""
CNC Shield Stepper Motor GUI Controller
Controls X, Y, Z stepper motors via Arduino UNO with CNC Shield

Installation requirements:
  pip install pyserial tkinter

Usage:
  python3 cnc_stepper_gui.py
"""
...
class StepperControllerGUI:
    def __init__(self, root):
        ...
        self.settings_path = Path(__file__).with_name("cnc_stepper_motor_settings.json")
